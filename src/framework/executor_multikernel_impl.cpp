...
//    ops_of_block0_.push_back(&(op_handler.get()));
//
//
//
//
...
//        if (var_desc->GetComputeType() == TYPE_GPU) {
//          // todo to be impl
//
//          CLImage *pImage = tensor_wrapper->MuteClImage();
//
//        } else if (var_desc->GetComputeType() == TYPE_CPU) {
//          LoDTensor *pTensor = tensor_wrapper->MuteLodTensor();
//
//          LoadMemory(reinterpret_cast<void **>(&data), var_desc, pTensor);
//        } else {
//        }
//
//        delete[] origin_data;
